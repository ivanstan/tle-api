...
{
    public const ALL_FLAGS = -1;
    public const SGP_INITIALIZED_FLAG = 0x000001;
    public const SGP4_INITIALIZED_FLAG = 0x000002;
    public const SDP4_INITIALIZED_FLAG = 0x000004;
    public const SGP8_INITIALIZED_FLAG = 0x000008;
    public const SDP8_INITIALIZED_FLAG = 0x000010;
    public const SIMPLE_FLAG = 0x000020;
    public const DEEP_SPACE_EPHEM_FLAG = 0x000040;
    public const LUNAR_TERMS_DONE_FLAG = 0x000080;
    public const NEW_EPHEMERIS_FLAG = 0x000100;
    public const DO_LOOP_FLAG = 0x000200;
    public const RESONANCE_FLAG = 0x000400;
    public const SYNCHRONOUS_FLAG = 0x000800;
    public const EPOCH_RESTART_FLAG = 0x001000;
    public const VISIBLE_FLAG = 0x002000;
    public const SAT_ECLIPSED_FLAG = 0x004000;

    /* orbit_type_t struct */
    public const ORBIT_TYPE_UNKNOWN = 0;
    public const ORBIT_TYPE_LEO = 1;            /* !< Low Earth orbit, up to 1200 km. */
    public const ORBIT_TYPE_ICO = 2;            /* !< Intermediate Circular Orbit, up to 1400 km. */
    public const ORBIT_TYPE_GEO = 3;            /* !< Geostationary. */
    public const ORBIT_TYPE_GSO = 4;            /* !< Geosynchronuous. */
    public const ORBIT_TYPE_MOLNIYA = 5;
    public const ORBIT_TYPE_TUNDRA = 6;
    public const ORBIT_TYPE_POLAR = 7;
    public const ORBIT_TYPE_SUNSYNC = 8;
    public const ORBIT_TYPE_DECAYED = 9;

    /* Entry points of Deep()
    // FIXME: Change to enu */
    public const dpinit = 1; /* Deep-space initialization code */
    public const dpsec = 2; /* Deep-space secular code */
    public const dpper = 3; /* Deep-space periodic code */
